...
namespace TestingFramework.AlgoIntegration
{
    public static class AlgoPack
    {
		...
		public static readonly Algorithm CSDIPy = new CSDIPyAlgorithm();
        ...
        public static Algorithm[] ListAlgorithms = { Stmvl, CdRec, Tkcm, Spirit, Trmf, Nnmf, Grouse, Svt, SoftImpute, ROSL, DynaMMo, SvdI, MeanImp, LinImp, Ssa, Mrnn, Brits, CSDIPy };
	...
	public partial class CSDIPyAlgorithm
	{
		public override string AlgCode => "csdipy";
		protected override string _EnvPath => $"{AlgoPack.GlobalNewAlgorithmsLocation}python/CSDIPy/";
		protected override string SubFolderDataIn => "in/";
		protected override string SubFolderDataOut => "out/";
